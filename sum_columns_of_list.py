...
#  and returns the result as an array/list/tuple. See the tests
#  for perhaps a better explination of the goal.

#  As usual there are many paths to the goal.
#  This first one is not elegant....
